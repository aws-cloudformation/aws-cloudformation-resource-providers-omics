...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetReferenceStoreResponse mockResponse = GetReferenceStoreResponse.builder()
                .id("testId")
                .arn("testArn")
                .name("testName")
                ...
                .build();
        when(proxyClient.client().getReferenceStore(any(GetReferenceStoreRequest.class)))
