...
public class CreateHandler extends BaseHandlerStd {
    ...
    private static final String CALL_GRAPH = "AWS-Omics-AnnotationStore::Create";
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
                .then(progress ->
                        proxy.initiate(CALL_GRAPH, proxyClient, progress.getResourceModel(), progress.getCallbackContext())
                                ...
                                .makeServiceCall(CallWrapper.wrap(proxyClient.client()::createAnnotationStore, logger))
    ...
    private Boolean stabilizeOnCreate(
            CreateAnnotationStoreRequest request,
            CreateAnnotationStoreResponse response,
        ...
        StoreStatus status =
                proxyClient.injectCredentialsAndInvokeV2(Translator.toReadRequest(model),
                        proxyClient.client()::getAnnotationStore).status();
