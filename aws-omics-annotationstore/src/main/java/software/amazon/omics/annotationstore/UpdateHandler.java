...
public class UpdateHandler extends BaseHandlerStd {
    ...
    private static final String CALL_GRAPH = "AWS-Omics-AnnotationStore::Update";
    @Override
    ...
    private ProgressEvent<ResourceModel, CallbackContext> updateResource(ProxyClient<OmicsClient> proxyClient,
        ...
        proxyClient.injectCredentialsAndInvokeV2(
                ...
                proxyClient.client()::updateAnnotationStore
        );
    ...
    private ProgressEvent<ResourceModel, CallbackContext> fetchResource(ProxyClient<OmicsClient> proxyClient,
        ...
        GetAnnotationStoreResponse getAnnotationStoreResponse
                ...
                proxyClient.client()::getAnnotationStore
        );
        ...
        ResourceModel modelBasedOnExistingResource
                = Translator.fromReadResponse(getAnnotationStoreResponse).getResourceModel();
