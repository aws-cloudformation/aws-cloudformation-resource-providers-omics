...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        ListVariantStoresResponse mockResponse = ListVariantStoresResponse.builder()
                .variantStores(store -> store
                        .id(testId)
                        .name(testName)
                        ...
                        .statusMessage("")
                        .storeSizeBytes(0L)
                        .storeArn("arn:aws:omics::test_account:variantStore/test_variant_store")
                        .build())
                .nextToken("testToken")
                .build();

        when(proxyClient.client().listVariantStores(any(ListVariantStoresRequest.class))).thenReturn(mockResponse);
